	                        ...
	                        <div class="card h-100">
	                            ...
	                            <div class="card-body p-4">
	                                <div class="text-center">
	                                    ...
	                                    <!-- Product price-->
	                                    <p class="strikethrough" style="text-decoration:line-through;"><fmt:formatNumber pattern="###,###,###" value="${item.price}" />원</p>
	                                    <p><fmt:formatNumber pattern="###,###,###" value="${item.salePrice}" />원</p>
	                                </div>
	                            </div>
	                            <!-- Product actions-->
